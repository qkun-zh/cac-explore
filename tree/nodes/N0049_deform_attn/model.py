"""N0049_deform_attn — placeholder deformable (fallback to MHA) + GCA+DDCA"""
...
class Counter(nn.Module):
    def __init__(self,cfg):
        ...
        self.cond=CondenserDeform(d_in=D,d_sim=d_model,d_out=_get(cfg,"cond_dim",64))
