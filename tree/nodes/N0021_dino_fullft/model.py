"""N0021_dino_fullft — champion recipe with FULL backbone fine-tuning + differential LR."""
import math
...
class DinoFullFT(nn.Module):
    def __init__(self, cfg):
        ...
        # FULL FINE-TUNING: no freeze, no eval lock
    ...
    def param_groups(self, base_lr, weight_decay):
        """Differential LR: backbone at mult×base, rest at base."""
