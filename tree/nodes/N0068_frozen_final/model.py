"""N0068_frozen_final — GCA+XScale on FINAL readout, backbone FROZEN (tune_stages=[]).
Backbone: DINOv3-ConvNeXt-Tiny hs_map (3,4) dims (384,768), all stages frozen.
Clean control vs N0054 (frozen intermediate hs(2,3)): isolates readout-layer choice
from the unfreeze confound. Head adapters scaled to 768ch exemplar/fuser.
"""
