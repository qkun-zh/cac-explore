"""N0014_dino_highres_augreg — merge winners: clone N0010 champion (518px) + N0013 augreg (photometric+bbox jitter)."""
import math
...
class DinoPromptV2(nn.Module):
    def __init__(self, cfg):
        ...
        self.head = nn.Sequential(nn.Conv2d(ch, 128, 1), nn.GELU(), nn.Dropout(drop),
                                  nn.Conv2d(128, 1, 1))
        # augmentation hyperparams (config-driven, defaults per N0013)
