"""N0027_norm_flip_swa — champion recipe (partial FT blocks10-11) + ImageNet input norm.

Only deltas vs N0021_dino_partialft: registered IMAGENET mean/std buffers applied at the
top of forward on the /255 tensor (H0037). Flip aug + SWA live in config/engine, not here."""
import math
...
class DinoPartialFT(nn.Module):
    def __init__(self, cfg):
        ...
        mean = (0.485, 0.456, 0.406)  # ImageNet stats (H0037); applied to the /255 tensor
